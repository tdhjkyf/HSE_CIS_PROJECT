...
window.zq = jquery_module/* default */.A;

// Setup the dialog, exported
var createPluginSetupWizard = function (appendTarget) {
  var $bs = enhanceJQueryWithBootstrap(jquery_module/* default */.A);
  ...
  runtime_default().registerHelper("eachDependency", function (plugName, options) {
    ...
    var deps = jquery_module/* default */.A.grep(plug.allDependencies, function (value) {
      // remove self
  ...
  var $wizard = (0,jquery_module/* default */.A)(pluginSetupWizard_default()());
  ...
  (0,jquery_module/* default */.A)(document).on("mouseenter", "*[data-tooltip]", function () {
    var $tip = $bs(this);
  ...
  $wizard.on("click", ".nav>li>a", function () {
    var $li = (0,jquery_module/* default */.A)(this).parent();
  ...
  var getJenkinsVersionFull = function () {
    var version = (0,jquery_module/* default */.A)("body").attr("data-version");
    if (!version) {
      return "";
    }
    return version;
  ...
  var setPanel = function (panel, data, onComplete) {
    ...
    var oncomplete = function () {
      var $content = (0,jquery_module/* default */.A)("*[data-load-content]");
      if ($content.length > 0) {
        $content.each(function () {
          var $el = (0,jquery_module/* default */.A)(this);
    ...
    var html = panel(jquery_module/* default */.A.extend({
    ...
    if (panel === currentPanel) {
      ...
      var $focusedItem = (0,jquery_module/* default */.A)(document.activeElement);
      var focusPath = [];
      ...
      var $upd = (0,jquery_module/* default */.A)(html);
      $upd.find("*[id]").each(function () {
        var $el = (0,jquery_module/* default */.A)(this);
        var $existing = (0,jquery_module/* default */.A)("#" + $el.attr("id"));
      ...
      try {
        var e = (0,jquery_module/* default */.A)("body")[0];
      ...
      var append = function () {
        ...
        if (translations.installWizard_jenkinsVersionTitle) {
          ...
          if ($modalFooter.length === 0) {
            $modalFooter = (0,jquery_module/* default */.A)('<div class="modal-footer"></div>').appendTo($container);
          }
  ...
  var initInstallingPluginList = function () {
    ...
    for (var i = 0; i < selectedPluginNames.length; i++) {
      ...
      if (p) {
        var plug = jquery_module/* default */.A.extend({
  ...
  var toggleDependencyList = function () {
    var $btn = (0,jquery_module/* default */.A)(this);
  ...
  var enableButtonsAfterFrameLoad = function () {
    (0,jquery_module/* default */.A)("iframe[src]").on("load", function () {
      (0,jquery_module/* default */.A)("button").prop({
        disabled: false
      });
    });
  };
  ...
  var displayErrors = function (iframe, errors) {
    ...
    var $iframeDoc = (0,jquery_module/* default */.A)(iframe).contents();
  ...
  var showSetupCompletePanel = function (messages) {
    api_pluginManager.getRestartStatus(function (restartStatus) {
      setPanel((setupCompletePanel_default()), jquery_module/* default */.A.extend(restartStatus, messages));
    });
  };
  ...
  var stateHandlers = {
    DEFAULT: function () {
      ...
      // focus on default
      (0,jquery_module/* default */.A)(".install-recommended").focus();
    },
  ...
  var showInstallProgress = function () {
    ...
    var attachScrollEvent = function () {
      var $c = (0,jquery_module/* default */.A)(".install-console-scroll");
      if (!$c.length) {
        setTimeout(attachScrollEvent, 50);
        return;
      }
      var events = jquery_module/* default */.A._data($c[0], "events");
    ...
    var updateStatus = function () {
      api_pluginManager.installStatus(handleGenericError(function (data) {
        ...
        // update progress bar
        (0,jquery_module/* default */.A)(".progress-bar").css({
          width: 100.0 * complete / total + "%"
        });

        // update details
        var $txt = (0,jquery_module/* default */.A)(".install-text");
        $txt.children().remove();
        for (i = 0; i < jobs.length; i++) {
          j = jobs[i];
          var txt = false;
          ...
          if (txt && state) {
            ...
            var $div = (0,jquery_module/* default */.A)("<div>" + txt + "</div>");
            if (isSelected) {
            ...
            $txt.append($div);
            var $itemProgress = (0,jquery_module/* default */.A)('.selected-plugin[id="installing-' + (0,id["default"])(j.name) + '"]');
    ...
    loadPluginData(function () {
      ...
      for (var i = 0; i < pluginList.length; i++) {
        ...
        for (var c = 0; c < a.plugins.length; c++) {
          ...
          plugs.push({
            category: a.category,
            plugin: jquery_module/* default */.A.extend({}, plug, {
  ...
  $wizard.on("change", ".plugin-list input[type=checkbox]", function () {
    var $input = (0,jquery_module/* default */.A)(this);
    if ($input.is(":checked")) {
  ...
  var scrollPlugin = function ($pl, matches, term) {
    if (matches.length > 0) {
      ...
      var $el = (0,jquery_module/* default */.A)(matches[findIndex]);
  ...
  var searchForPlugins = function (text, scroll) {
    var $pl = (0,jquery_module/* default */.A)(".plugin-list");
    ...
    if (text.length > 1) {
      if (text === "show:selected") {
        (0,jquery_module/* default */.A)(".plugin-list .selected").addClass("match");
      } else {
        var matches = [];
        ...
        (0,jquery_module/* default */.A)(matches).parents(".plugin").addClass("match");
        if (lastSearch !== text && scroll) {
          scrollPlugin($pl, matches, text);
        }
      }
      (0,jquery_module/* default */.A)(".match").parent().prev("h2").addClass("match");
  ...
  $wizard.on("keyup change", ".plugin-select-controls input[name=searchbox]", function () {
    var val = (0,jquery_module/* default */.A)(this).val();
  ...
  $wizard.on("keydown", ".plugin-list", function (e) {
    ...
    var $plugin = (0,jquery_module/* default */.A)(e.target).closest(".plugin");
    if ($plugin && $plugin.length > 0) {
      var $allPlugins = (0,jquery_module/* default */.A)(".plugin-list .plugin:visible");
      var idx = $allPlugins.index($plugin);
      var next = idx + (up ? -1 : 1);
      if (next >= 0 && next < $allPlugins.length) {
        var $next = (0,jquery_module/* default */.A)($allPlugins[next]);
  ...
  var selectCategory = function () {
    (0,jquery_module/* default */.A)("input[name=searchbox]").val("");
    searchForPlugins("", false);
    var $el = (0,jquery_module/* default */.A)((0,jquery_module/* default */.A)(this).attr("href"));
    var $pl = (0,jquery_module/* default */.A)(".plugin-list");
  ...
  var toggleInstallDetails = function () {
    var $c = (0,jquery_module/* default */.A)(".install-console");
    if ($c.is(":visible")) {
      $c.slideUp();
    } else {
      $c.slideDown();
  ...
  var handleFirstUserResponseError = function (res) {
    ...
    var $page = (0,jquery_module/* default */.A)(responseText);
    var $main = $page.find("#main-panel").detach();
    if ($main.length > 0) {
      responseText = responseText.replace(/body([^>]*)[>](.|[\r\n])+[<][/]body/, "body$1>" + $main.html() + "</body");
    }
    var doc = (0,jquery_module/* default */.A)("iframe#setup-first-user").contents()[0];
    doc.open();
  ...
  var saveFirstUser = function () {
    ...
    var $form = (0,jquery_module/* default */.A)("iframe#setup-first-user").contents().find("form:not(.no-json)");
  ...
  var handleConfigureInstanceResponseSuccess = function (data) {
    if (data.status === "ok") {
      ...
      setPanel((configureInstance_default()), {}, function () {
        ...
        displayErrors((0,jquery_module/* default */.A)("iframe#setup-configure-instance"), errors);
      });
    }
  };
  var handleConfigureInstanceResponseError = function (res) {
    ...
    var doc = (0,jquery_module/* default */.A)("iframe#setup-configure-instance").contents()[0];
    doc.open();
    doc.write(responseText);
    doc.close();
    (0,jquery_module/* default */.A)("button").prop({
  ...
  var saveConfigureInstance = function () {
    ...
    var $form = (0,jquery_module/* default */.A)("iframe#setup-configure-instance").contents().find("form:not(.no-json)");
  ...
  var saveProxyConfig = function () {
    securityConfig.saveProxy((0,jquery_module/* default */.A)("iframe[src]").contents().find("form:not(.no-json)"), function () {
  ...
  if ("undefined" !== typeof setupWizardExtensions) {
    jquery_module/* default */.A.each(setupWizardExtensions, function () {
      this.call(self, {
        $: jquery_module/* default */.A,
        $wizard: $wizard,
        jenkins: util_jenkins,
        pluginManager: api_pluginManager,
        setPanel: setPanel,
        addActions: function (pluginActions) {
          jquery_module/* default */.A.extend(actions, pluginActions);
        },
        addStateHandlers: function (pluginStateHandlers) {
          jquery_module/* default */.A.extend(stateHandlers, pluginStateHandlers);
        },
  ...
  util_jenkins.loadTranslations("jenkins.install.pluginSetupWizard", handleGenericError(function (localizations) {
    ...
    jquery_module/* default */.A.each(extensionTranslationOverrides, function () {
      this(translations);
    });
...
(0,jquery_module/* default */.A)(function () {
  (0,jquery_module/* default */.A)(".plugin-setup-wizard-container").each(function () {
    var $container = (0,jquery_module/* default */.A)(this);
